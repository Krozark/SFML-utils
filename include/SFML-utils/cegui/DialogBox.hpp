    ...
    namespace cegui
    {
        class DialogBox : public PopupBox
        {
            public:
                ...
                static void getInt(CEGUI::Window* parent,const std::string& title,const std::string& text,const std::function<void(int)>& ok, const std::function<void()>& cancel);
                ...
                static void getDouble(CEGUI::Window* parent,const std::string& title,const std::string& text,const std::function<void(double)>& ok, const std::function<void()>& cancel);
                ...
                static void getString(CEGUI::Window* parent,const std::string& title,const std::string& text,const std::function<void(const std::string&)>& ok, const std::function<void()>& cancel);
                ...
                static void getItem(CEGUI::Window* parent,const std::string title,const std::string& text,const std::list<std::string>& choices,const std::function<void(const std::string&)>& ok, const std::function<void()>& cancel);
                ...
                static void message(CEGUI::Window* parent,const std::string& title,const std::string& text,const std::function<void()>& ok, const std::function<void()>& cancel);
